...
let stiker = await sticker(null, global.API(`https://telegra.ph/file/d34b2ab2cb233c749776c.png`), global.packname, global.author)
 conn.sendFile(m.chat, stiker, 'sticker.webp', '', m, null, { fileLength: 100, contextInfo: {
    ...
    mediaUrl: sig,
    mediaType: 2,
    description: '𝐗𝐎𝐫𝐜𝐢𝐬𝐭𝐆𝐚𝐧𝐬 𝑿 𝐗𝐎𝐫𝐜𝐢𝐬𝐭𝐆𝐚𝐧𝐬 - 𝐁𝐎𝐓', 
...
let audio = `https://raw.githubusercontent.com/𝐗𝐎𝐫𝐜𝐢𝐬𝐭𝐆𝐚𝐧𝐬/Soundskane/master/${command}.mp3`
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/kingdomidn_',
    ...
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://i.ibb.co/wL0PQ7K/20230214-192657.jpg')).buffer(),
